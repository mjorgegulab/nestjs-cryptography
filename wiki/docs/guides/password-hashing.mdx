...
[3]: /docs/api-reference/settings
[4]: /docs/intro#configuration

[5]: /docs/api-reference/settings#outputkeylength
[6]: /docs/api-reference/settings#argon2type-1
[7]: /docs/api-reference/settings#memorycost-1
[8]: /docs/api-reference/settings#timecost-1
