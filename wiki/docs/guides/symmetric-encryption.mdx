...
## Symmetric secure data encrypt <RecommendedLabel />
...
## Symmetric secure data decrypt <RecommendedLabel />
...
## Symmetric data encrypt <GenericLabel />
...
## Symmetric data decrypt <GenericLabel />
