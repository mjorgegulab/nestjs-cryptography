...
[2]: /docs/intro#configuration

[3]: /docs/api-reference/settings#defaultoutputkeylength
[4]: /docs/api-reference/settings#argon2type
[5]: /docs/api-reference/settings#memorycost
[6]: /docs/api-reference/settings#timecost
